...
<head>
  ...
  *               {padding:0;margin:0;font: 26px 'Quicksand', sans-serif;color:#eee;}
  ...
  .tutbtn{position:fixed;left:10px;top:0px;border: solid 1px #333;box-shadow:inset 0 0 3px 0 #000;border-radius: 4px;font-weight:100;font: 11px 'Quicksand', sans-serif;display: block;padding: 2px;padding-left:10px;}
...
<div class="dailytop">
  ...
  <script>
  kongregate.stats.submit("userlevel",<?php echo getUserLevel($username); ?>);
  $('.play').click(function() {
